export default function AboutCTA(){
    return(<>
    <div className="grid grid-cols-6 h-[350px] bg-[url('/homeCTAbg.jpg')] bg-cover">
        ...
        <div className="col-span-4 col-start-2 text-center font-bold">
            <button className="hover:bg-slate-400 py-4 px-6 rounded-md bg-slate-300 text-jet">ABOUT REPLAY</button>
        </div>
    </div>
    </>)
}